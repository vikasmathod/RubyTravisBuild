...
describe Azure::VirtualMachineManagementService do
  ...
  describe '#list_virtual_machines' do
    ...
    it 'returns a list of virtual machine images' do
      ...
      assert(virtualmachine.vm_name, virtual_machine_name)
      assert(virtualmachine.role_size, 'Small')
      assert(virtualmachine.cloud_service_name, cloud_service_name)
      assert(virtualmachine.deployment_name, cloud_service_name)
      assert(virtualmachine.deployment_status, 'Running')
